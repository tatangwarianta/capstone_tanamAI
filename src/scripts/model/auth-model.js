const AuthModel = {
    async login(email, password) {
        ...
        // ✅ Proses login online
        const response = await fetch('https://tanamaibackend-production.up.railway.app/login', {
        method: 'POST',
    ...
    async register(name, email, password) {
        const response = await fetch('https://tanamaibackend-production.up.railway.app/register', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
